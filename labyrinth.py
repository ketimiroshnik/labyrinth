...
class Labyrinth:
    ...
    def is_free(self, position):
        return self.get_tile_id(position) in self.free_tles
...
class Hero:
    ...
    def render(self, screen):
        ...
        pygame.draw.ellipse(screen, (255, 255, 255), (self.x * TILE_SIZE, self.y * TILE_SIZE,
                                                      TILE_SIZE, TILE_SIZE))
...
class Enemy:
    ...
    def render(self, screen):
        # center = self.x * TILE_SIZE + TILE_SIZE // 2, self.y * TILE_SIZE + TILE_SIZE // 2
        pygame.draw.ellipse(screen, pygame.color.Color('brown'), (self.x * TILE_SIZE, self.y * TILE_SIZE,
                                                                  TILE_SIZE, TILE_SIZE))
...
class Game:
    ...
    def check_lose(self):
        return self.enemy.get_position() == self.hero.get_position()
